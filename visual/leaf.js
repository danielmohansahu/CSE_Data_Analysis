//////////////////////////////// INITIALIZATION ////////////////////////////////
// For testing purposes; to be generated by patient:
var input = {"Body Height": 160, 
  "Body Weight": 100, 
  "age_years": 54, 
  "Creatinine": 0.6,
  "Calcium": 10,
...
function update(source,highlight_flag = false) {
...
// TODO: Closing an upstream node should close all downstream nodes as well.
...
function chance_of_hd(d,biometrics) {
  if (d.is_leaf == 1) {
    ...
    if (biometrics[name] < val) {
      // Return first child
      if (d.children) {
        return chance_of_hd(d.children[0],biometrics)
      } else {
        return chance_of_hd(d._children[0],biometrics)
      }
    } else {
      // Return second child
      if (d.children) {
        return chance_of_hd(d.children[1],biometrics)
      } else {
        return chance_of_hd(d._children[1],biometrics)
      }
    }
  }
}